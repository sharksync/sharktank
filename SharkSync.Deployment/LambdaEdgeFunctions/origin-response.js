...
exports.handler = function (event, context, callback) {
    ...
    headers['Content-Security-Policy'] = "default-src 'self' data:;script-src 'self';style-src 'self' 'unsafe-inline';img-src 'self' data:;font-src 'self' data:;connect-src 'self' https://localhost:44325;block-all-mixed-content";
